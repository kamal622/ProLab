...
Public Class PatientServiceListForm
    ...
    Private Sub btnSearchTestList_Click(sender As Object, e As EventArgs) Handles btnSearchTestList.Click
        Try
            ...
            ReportViewer1.LocalReport.SetParameters(New ReportParameter("FromDate", dtFromDate.Value))
            ReportViewer1.LocalReport.SetParameters(New ReportParameter("ToDate", dtToDate.Value))
            Dim dataSource = New ReportDataSource("TestReportListDataSet", dtbl)
    ...
    Private Sub PatientServiceListForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
